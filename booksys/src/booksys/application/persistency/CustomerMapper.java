...
public class CustomerMapper
{
  ...
  private Hashtable<Integer, PersistentCustomer> cache ;
  ...
  private PersistentCustomer getFromCacheByDetails(String name, String phone)
  {
    ...
    Enumeration<PersistentCustomer> enumeration = cache.elements() ;
  ...
  {
    cache = new Hashtable<Integer, PersistentCustomer>() ;
  }
